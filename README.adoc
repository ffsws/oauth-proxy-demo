...
This project demonstrates how to use the https://github.com/openshift/oauth-proxy[`oauth-proxy`] sidecar container in an OpenShift cluster. It can be seen running at https://vshn-oauth-proxy-demo.appuioapp.ch/[APPUiO].
